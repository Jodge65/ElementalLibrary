 ...
 * 
 */
@Mod(modid = Main.MODID, name = Main.MODNAME, version = Main.MODVER, dependencies = "required-after:Baubles",acceptedMinecraftVersions = "[1.10]")
public class Main
{
